        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('pembayaran.save', $penjualan->kode_penjualan) }}" method="post"
                    id="<?php echo $_GET['tab'] == 'split-bill' ? 'split-bill-form' : ''; ?>">
                    @csrf
                    @method('put')
                    <input type="hidden" id="kode" name='kode_penjualan' value="{{ $penjualan->kode_penjualan }}"
                        readonly>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    ...
                                    <input type="text"
                                        class="form-control form-line @error('nama_customer') is-invalid @enderror"
                                        name='nama_customer' value="{{ $penjualan->nama_customer }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="number"
                                        class="form-control form-line @error('no_hp') is-invalid @enderror" name='no_hp'
                                        value="{{ $penjualan->no_hp }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <div class="form-line-check">
                                    <span class='fa fa-check-circle'></span>
                                    <input type="text"
                                        class="form-control form-line @error('jenis_order') is-invalid @enderror"
                                        name='jenis_order' value="{{ $penjualan->jenis_order }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table align-items-center table-flush table-striped table-hover">
                            ...
                            <tbody class="list">
                                ...
                                @foreach ($detail as $value)
                                    @php
                                        $menu = \App\Menu::select('nama', 'foto')
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('assets/img/menu/' . $menu->foto) }}" width='150px'
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($penjualan->total_harga - $penjualan->total_diskon, 0, ',', '.') }}
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <ul class="nav nav-tabs tabs-bill-option mb-3">
                                    <li class="nav-item"><a class="nav-link <?php echo $_GET['tab'] == 'normal' ? 'active' : ''; ?>" href="?tab=normal">Normal
                                            Payment</a></li>
                                    <li class="nav-item"><a class="nav-link <?php echo $_GET['tab'] == 'split-bill' ? 'active' : ''; ?>"
                                            href="?tab=split-bill">Split Bill</a></li>
                                </ul>
                            </div>
                        </div>
                  ...
                  ?>
                        ...
                        <div class="row" id='normal-payment'>
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="number" name="diskon" class="form-control diskon_tambahan"
                                    data-tipe='persen' value="{{ old('diskon', 0) }}">
                            </div>
                            <div class="col-4 mb-2">
                                <label for=""><strong>Potongan</strong></label>
                                <input type="number" name="diskon_tambahan" class="form-control potongan"
                                    value="{{ old('diskon_tambahan', 0) }}" data-tipe='rp'>
                            </div>
                            <div class="col-4 mb-2">
                                <label for=""><strong>Metode Pembayaran</strong></label>
                                <select name="jenis_bayar" class="form-control @error('bayar') is-invalid @enderror"
                                    id="jenis_bayar">
                                    <option value="Tunai" {{ old('jenis_bayar') == 'Tunai' ? 'selected' : '' }}>Tunai
                                    </option>
                                    <option value="Shopee Food"
                                        {{ old('jenis_bayar') == 'Shopee Food' ? 'selected' : '' }}>Shopee Food</option>
                                    <option value="Gofood" {{ old('jenis_bayar') == 'Gofood' ? 'selected' : '' }}>Gofood
                                    </option>
                                    <option value="Debit BCA" {{ old('jenis_bayar') == 'Debit BCA' ? 'selected' : '' }}>
                                        Debit BCA</option>
                                    <option value="Debit BRI" {{ old('jenis_bayar') == 'Debit BRI' ? 'selected' : '' }}>
                                        Debit BRI</option>
                                    <option value="Debit Bank Lain"
                                        {{ old('jenis_bayar') == 'Debit Bank Lain' ? 'selected' : '' }}>Debit Bank Lain
                                    </option>
                                    <option value="Kredit BCA" {{ old('jenis_bayar') == 'Kredit BCA' ? 'selected' : '' }}>
                                        Kredit BCA</option>
                                    <option value="Kredit BRI" {{ old('jenis_bayar') == 'Kredit BRI' ? 'selected' : '' }}>
                                        Kredit BRI</option>
                                    <option value="Kredit Bank Lain"
                                        {{ old('jenis_bayar') == 'Kredit Bank Lain' ? 'selected' : '' }}>Kredit Bank Lain
                                    </option>
                                    <option value="QRIS" {{ old('jenis_bayar') == 'QRIS' ? 'selected' : '' }}>QRIS
                                    </option>
                                </select>
                                @error('jenis_bayar')
                            ...
                            <div class="col-4 mb-2">
                                <div id="debit_only">
                                    ...
                                    <input type="number" name="no_kartu" id="no_kartu" class="form-control"
                                        value="{{ old('no_kartu') }}">
                                    {{-- @error('jenis_bayar')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          ...
                          @enderror --}}
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="isTravel" name="isTravel"
                                        value="True" {{ old('isTravel') == 'True' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-2 text-center list-user-bill" data-count='1'>
                                ...
                                <div class="mt-4">
                                    <a href="" id='add-new-user-bill'><span
                                            class="fa fa-2x fa-plus-circle"></span></a>
                                </div>
                            </div>
                            <div class="col-md-10">
                                <label for="">Pilih Menu</label>
                                <div class="form-control" id="user-bill-menu" data-url="{{ route('menu-bill') }}"
                                    data-kodepenjualan="{{ $penjualan->kode_penjualan }}">
                                    @foreach ($detail as $key => $value)
                                        ...
                                        @endphp
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input menuCheck"
                                                id="customCheck{{ $key }}" data-qty="{{ $value->qty }}"
                                                value="{{ $value->kode_menu }}">
                                            <label class="custom-control-label"
                                                for="customCheck{{ $key }}">{{ $menu->nama }} <span
                                                    class="badge badge-primary badge-pill"
                                                    for='{{ $value->kode_menu }}'>{{ $value->qty }}</span> </label>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="row split-bill">
                            <input type="hidden" name="" id="total" class="form-control" value="0"
                                readonly>
                            <div class="col-4 mb-2">
                                <label for=""><strong>Diskon(%)</strong></label>
                                <input type="number" name="diskon" class="form-control diskon_tambahan"
                            ...
                            <div class="col-md-4 mt-4">
                                <h1 class='text-dark'>Grand Total : Rp. <span class="text-orange"
                                        id='idrGrandTotal'>0</span></h1>
                                <input type="hidden" name="grand_total" id="grand_total"
                                    class="form-control form-line text-lg text-orange font-weight-bold" value="0">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="data-pembayaran">
                            <div class='guest-pembayaran' data-key='1'>
                                ...
                                <input type='hidden' class='pembDiskonTambahan' name='diskon_tambahan[1]'
                                    value='0'>
